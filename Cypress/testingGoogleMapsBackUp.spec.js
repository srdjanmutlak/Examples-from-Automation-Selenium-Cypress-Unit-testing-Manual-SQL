describe('Testing google maps: Since google maps are constantly updating there could be a case of changing the position of the longest path. Therefore two of these tests will fail, but one will pass. If one test is passable whole test passes' , () => {

    it('Testing if longest route is in the first place, this time we change inputs to Budapest - Belgrade', () => {
       ...
       cy.get("button[aria-label='Путања до Београд']", { timeout: 100000 }).click({ force: true })
...
it('Testing if longest route is in the second place, this time we change inputs to Budapest - Belgrade', () => {
...
it('Testing if longest route is in the third place, this time we change inputs to Budapest - Belgrade', () => {
