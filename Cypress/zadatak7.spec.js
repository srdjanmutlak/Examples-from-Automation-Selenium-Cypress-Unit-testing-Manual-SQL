describe('Testiranje prosledjivanja kvara', () => {
    ...
    it('test polje za pretragu u dijalogu za izbor odgovornog lica', () => {
        ...
        cy.xpath("//span[contains(text(),'izmeni odgovorno lice')]").click()
            ...
            cy.get("tr[class='table-secondary']")
        ...
        it('prihvatanje opstine', () => {
            ...
            cy.xpath("//td[normalize-space()='opstina@gmail.com']", { timeout: 20000 }).should('be.visible');
            
            cy.xpath("(//div[@class='modal-content'] //div //tr //td[contains(.,'Prihvati')] //button)[1]").click() 

            cy.get('.toast-message')
            .should('have.text', ' Odgovorno lice uspesno izmenjeno ', { timeout: 10000 })
        ...
        cy.xpath("//td[contains(.,'Ne radi svetlo u hodniku.')]").should('contain', 'Ne radi svetlo u hodniku.');
