describe('Make an HTTP requestX', () => {
    ...
    cy.request({                                                                
            ...
            expect(response.body[2]).to.have.property('broj', 12) 
            expect(response.body[2]).to.have.property('brojStanova', 5) 
            expect(response.body[2]).to.have.property('lokacija', "Zrenjanin") 
            expect(response.body[2]).to.have.property('ulica', "Malina") 
