...
public class UserMngmnt {
	...
	public void clickActivateUser() {
		WebElement el = new WebDriverWait(driver, 10)
				.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//input[@id='activated']")));
		el.click();
	}
	 ...
	 * 
	 */
	public WebElement getEntityRowByValue(String value) {
		return Utils.waitForElementVisibility(driver, By.xpath("//*[contains(text(),\"" + value + "\")]/../.."), 10);
		}
